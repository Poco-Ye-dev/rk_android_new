...
bool dhd_conf_he_chip(dhd_pub_t *dhd);
bool dhd_conf_eht_chip(dhd_pub_t *dhd);
uint wl_iovt2len(uint iovt);
const sub_cmd_t * dhd_conf_get_sub_cmd(char *cmd, char *sub_cmd);
#endif
