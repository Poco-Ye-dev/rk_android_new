...
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(5, 2, 0)) || defined(WL_AP_OWE_BKPORT)
static int wl_cfg80211_update_owe_info(struct wiphy *wiphy, struct net_device *dev,
	struct cfg80211_update_owe_info *oweinfo);
#endif /* LINUX_VERSION_CODE >= KERNEL_VERSION(5, 2, 0) || WL_AP_OWE_BKPORT */
...
#endif /* CONFIG_PM */
#if defined(WL_CAP_HE) && defined(WIPHY_INFO_UPDATE)
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(4, 19, 0)) || defined(CONFIG_6GHZ_BKPORT)
	struct ieee80211_supported_band *bands;
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(5, 18, 0)) || defined(WL_MLO_BKPORT)
#ifndef DISABLE_EHT_CAP
	struct ieee80211_sband_iftype_data *iftdata;
#endif /* DISABLE_EHT_CAP */
#endif /* LINUX_VERSION_CODE >= KERNEL_VERSION(5, 18, 0) || WL_MLO_BKPORT */
#endif /* LINUX_VERSION_CODE >= KERNEL_VERSION(4, 19, 0)  || CONFIG_6GHZ_BKPORT */
#endif /* WL_CAP_HE && WIPHY_INFO_UPDATE */
	struct net_device *ndev = NULL;
	BCM_REFERENCE(dhd);
...
#if defined(WL_CAP_HE) && defined(WIPHY_INFO_UPDATE)
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(4, 19, 0)) || defined(CONFIG_6GHZ_BKPORT)
	bands = wdev->wiphy->bands[IEEE80211_BAND_2GHZ];
	if (!dhd_conf_he_chip(dhd)) {
		bands->iftype_data = NULL;
		bands->n_iftype_data = 0;
	}
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(5, 18, 0)) || defined(WL_MLO_BKPORT)
#ifndef DISABLE_EHT_CAP
	else if (!dhd_conf_eht_chip(dhd)) {
		iftdata = bands->iftype_data;
		iftdata->eht_cap.has_eht = FALSE;
	}
#endif /* DISABLE_EHT_CAP */
#endif /* LINUX_VERSION_CODE >= KERNEL_VERSION(5, 18, 0) || WL_MLO_BKPORT */
#endif /* LINUX_VERSION_CODE >= KERNEL_VERSION(4, 19, 0)  || CONFIG_6GHZ_BKPORT */
...
static s32 __wl_update_wiphybands(struct bcm_cfg80211 *cfg, bool notify)
{
...
#if defined(WL_CAP_HE) && defined(WIPHY_INFO_UPDATE)
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(4, 19, 0)) || defined(CONFIG_6GHZ_BKPORT)
	wl_ext_get_xtlv_uint(dev, "he", "enab", &hemode);
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(5, 18, 0)) || defined(WL_MLO_BKPORT)
#ifndef DISABLE_EHT_CAP
	wl_ext_get_xtlv_uint(dev, "eht", "enab", &ehtmode);
#endif /* DISABLE_EHT_CAP */
#endif /* LINUX_VERSION_CODE >= KERNEL_VERSION(5, 18, 0) || WL_MLO_BKPORT */
#endif /* LINUX_VERSION_CODE >= KERNEL_VERSION(4, 19, 0)  || CONFIG_6GHZ_BKPORT */
#endif /* WL_CAP_HE && WIPHY_INFO_UPDATE */
	...
	for (i = 1; i <= nband && i < ARRAYSIZE(bandlist); i++) {
		...
		if (bands[index]->iftype_data) {
			if (!hemode) {
				bands[index]->iftype_data = NULL;
				bands[index]->n_iftype_data = 0;
			}
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(5, 18, 0)) || defined(WL_MLO_BKPORT)
#ifndef DISABLE_EHT_CAP
			else if (hemode && !ehtmode) {
				iftdata = bands[index]->iftype_data;
				iftdata->eht_cap.has_eht = FALSE;
			}
#endif /* LINUX_VERSION_CODE >= KERNEL_VERSION(5, 18, 0) || WL_MLO_BKPORT */
#endif /* LINUX_VERSION_CODE >= KERNEL_VERSION(4, 19, 0)  || CONFIG_6GHZ_BKPORT */
		}
#endif /* KERNEL >= 4.19 || CONFIG_6GHZ_BKPORT */
#endif /* WL_CAP_HE && WIPHY_INFO_UPDATE */
