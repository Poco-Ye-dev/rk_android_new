...
#define ATTR_INIT_A12 0
#else
#define ATTR_INIT_A12 (-1)
#endif /* ANDROID_VERSION >= 12 */
#if ANDROID_VERSION >= 11
#define ATTR_INIT_A11 0
#else
#define ATTR_INIT_A11 (-1)
#endif /* ANDROID_VERSION >= 11 */

enum rtt_attributes {
	RTT_ATTRIBUTE_INVALID			= ATTR_INIT_A12 + 0,
	RTT_ATTRIBUTE_TARGET_CNT		= ATTR_INIT_A12 + 1,
	RTT_ATTRIBUTE_TARGET_INFO		= ATTR_INIT_A12 + 2,
	RTT_ATTRIBUTE_TARGET_MAC		= ATTR_INIT_A12 + 3,
	RTT_ATTRIBUTE_TARGET_TYPE		= ATTR_INIT_A12 + 4,
	RTT_ATTRIBUTE_TARGET_PEER		= ATTR_INIT_A12 + 5,
	RTT_ATTRIBUTE_TARGET_CHAN		= ATTR_INIT_A12 + 6,
	RTT_ATTRIBUTE_TARGET_PERIOD		= ATTR_INIT_A12 + 7,
	RTT_ATTRIBUTE_TARGET_NUM_BURST		= ATTR_INIT_A12 + 8,
	RTT_ATTRIBUTE_TARGET_NUM_FTM_BURST	= ATTR_INIT_A12 + 9,
	RTT_ATTRIBUTE_TARGET_NUM_RETRY_FTM	= ATTR_INIT_A12 + 10,
	RTT_ATTRIBUTE_TARGET_NUM_RETRY_FTMR	= ATTR_INIT_A12 + 11,
	RTT_ATTRIBUTE_TARGET_LCI		= ATTR_INIT_A12 + 12,
	RTT_ATTRIBUTE_TARGET_LCR		= ATTR_INIT_A12 + 13,
	RTT_ATTRIBUTE_TARGET_BURST_DURATION	= ATTR_INIT_A12 + 14,
	RTT_ATTRIBUTE_TARGET_PREAMBLE		= ATTR_INIT_A12 + 15,
	RTT_ATTRIBUTE_TARGET_BW			= ATTR_INIT_A12 + 16,
	RTT_ATTRIBUTE_TARGET_MIN_DELTA		= ATTR_INIT_A12 + 17,
	RTT_ATTRIBUTE_TARGET_MAX_DELTA		= ATTR_INIT_A12 + 18,
	/* RTT Result Attributes */
	RTT_ATTRIBUTE_RESULTS_COMPLETE		= ATTR_INIT_A12 + 30,
	RTT_ATTRIBUTE_RESULTS_PER_TARGET	= ATTR_INIT_A12 + 31,
	RTT_ATTRIBUTE_RESULT_CNT		= ATTR_INIT_A12 + 32,
	RTT_ATTRIBUTE_RESULT			= ATTR_INIT_A12 + 33,
	RTT_ATTRIBUTE_RESULT_DETAIL		= ATTR_INIT_A12 + 34,
	RTT_ATTRIBUTE_RESULT_FREQ		= ATTR_INIT_A12 + 35,
	RTT_ATTRIBUTE_RESULT_BW			= ATTR_INIT_A12 + 36,
	RTT_ATTRIBUTE_RESULT_I2R_LTF_REP_COUNT  = ATTR_INIT_A12 + 37,
	RTT_ATTRIBUTE_RESULT_R2I_LTF_REP_COUNT	= ATTR_INIT_A12 + 38,
	RTT_ATTRIBUTE_RESULT_NTB_MIN_DELTA	= ATTR_INIT_A12 + 39,
	RTT_ATTRIBUTE_RESULT_NTB_MAX_DELTA	= ATTR_INIT_A12 + 40,

	/* Security */
	RTT_ATTRIBUTE_TARGET_PROTECTED_FRM_REQD	= ATTR_INIT_A12 + 41,
	RTT_ATTRIBUTE_TARGET_KEY_LIFE_TIME      = ATTR_INIT_A12 + 42,
	RTT_ATTRIBUTE_TARGET_RTT_AKM            = ATTR_INIT_A12 + 43,
	RTT_ATTRIBUTE_TARGET_SEC_LTF_REQD       = ATTR_INIT_A12 + 44,
	RTT_ATTRIBUTE_TARGET_KEY_PASSPHRASE     = ATTR_INIT_A12 + 45,
	RTT_ATTRIBUTE_TARGET_KEY_PASSPHRASE_LEN = ATTR_INIT_A12 + 46,
	RTT_ATTRIBUTE_TARGET_CIPHER_TYPE        = ATTR_INIT_A12 + 47,

	RTT_ATTRIBUTE_RESULT_NTB_I2R_STS	= ATTR_INIT_A12 + 48,
	RTT_ATTRIBUTE_RESULT_NTB_R2I_STS	= ATTR_INIT_A12 + 49,
	RTT_ATTRIBUTE_RESULT_RNG_PROT_ENABLED	= ATTR_INIT_A12 + 50,
	RTT_ATTRIBUTE_RESULT_SLTF_ENABLED	= ATTR_INIT_A12 + 51,
	RTT_ATTRIBUTE_RESULT_RTT_AKM		= ATTR_INIT_A12 + 52,
	RTT_ATTRIBUTE_RESULT_CIPHER_TYPE	= ATTR_INIT_A12 + 53,
	RTT_ATTRIBUTE_RESULT_SLTF_PROTO_VER	= ATTR_INIT_A12 + 54,
...
enum wifi_rssi_monitor_attr {
	RSSI_MONITOR_ATTRIBUTE_INVALID		= ATTR_INIT_A12 + 0,
	RSSI_MONITOR_ATTRIBUTE_MAX_RSSI		= ATTR_INIT_A12 + 1,
	RSSI_MONITOR_ATTRIBUTE_MIN_RSSI		= ATTR_INIT_A12 + 2,
	RSSI_MONITOR_ATTRIBUTE_START		= ATTR_INIT_A12 + 3,
...
enum debug_attributes {
	DEBUG_ATTRIBUTE_INVALID			= ATTR_INIT_A12 + 0,
	DEBUG_ATTRIBUTE_GET_DRIVER		= ATTR_INIT_A12 + 1,
	DEBUG_ATTRIBUTE_GET_FW			= ATTR_INIT_A12 + 2,
	DEBUG_ATTRIBUTE_RING_ID			= ATTR_INIT_A12 + 3,
	DEBUG_ATTRIBUTE_RING_NAME		= ATTR_INIT_A12 + 4,
	DEBUG_ATTRIBUTE_RING_FLAGS		= ATTR_INIT_A12 + 5,
	DEBUG_ATTRIBUTE_LOG_LEVEL		= ATTR_INIT_A12 + 6,
	DEBUG_ATTRIBUTE_LOG_TIME_INTVAL		= ATTR_INIT_A12 + 7,
	DEBUG_ATTRIBUTE_LOG_MIN_DATA_SIZE	= ATTR_INIT_A12 + 8,
	DEBUG_ATTRIBUTE_FW_DUMP_LEN		= ATTR_INIT_A12 + 9,
	DEBUG_ATTRIBUTE_FW_DUMP_DATA		= ATTR_INIT_A12 + 10,
	DEBUG_ATTRIBUTE_FW_ERR_CODE		= ATTR_INIT_A11 + ATTR_INIT_A12 + 11,
	DEBUG_ATTRIBUTE_RING_DATA		= ATTR_INIT_A11 + ATTR_INIT_A12 + 12,
	DEBUG_ATTRIBUTE_RING_STATUS		= ATTR_INIT_A11 + ATTR_INIT_A12 + 13,
	DEBUG_ATTRIBUTE_RING_NUM		= ATTR_INIT_A11 + ATTR_INIT_A12 + 14,
	DEBUG_ATTRIBUTE_DRIVER_DUMP_LEN		= ATTR_INIT_A11 + ATTR_INIT_A12 + 15,
	DEBUG_ATTRIBUTE_DRIVER_DUMP_DATA	= ATTR_INIT_A11 + ATTR_INIT_A12 + 16,
	DEBUG_ATTRIBUTE_PKT_FATE_NUM		= ATTR_INIT_A11 + ATTR_INIT_A12 + 17,
	DEBUG_ATTRIBUTE_PKT_FATE_DATA		= ATTR_INIT_A11 + ATTR_INIT_A12 + 18,
	DEBUG_ATTRIBUTE_HANG_REASON		= ATTR_INIT_A11 + ATTR_INIT_A12 + 19,
	DEBUG_ATTRIBUTE_BUF_RING_NUM		= ATTR_INIT_A11 + ATTR_INIT_A12 + 20,
	DEBUG_ATTRIBUTE_BUF_RING_MAP		= ATTR_INIT_A11 + ATTR_INIT_A12 + 21,
...
enum mkeep_alive_attributes {
	MKEEP_ALIVE_ATTRIBUTE_INVALID = ATTR_INIT_A12 + 0,
	MKEEP_ALIVE_ATTRIBUTE_ID = ATTR_INIT_A12 + 1,
	MKEEP_ALIVE_ATTRIBUTE_IP_PKT = ATTR_INIT_A12 + 2,
	MKEEP_ALIVE_ATTRIBUTE_IP_PKT_LEN = ATTR_INIT_A12 + 3,
	MKEEP_ALIVE_ATTRIBUTE_SRC_MAC_ADDR = ATTR_INIT_A12 + 4,
	MKEEP_ALIVE_ATTRIBUTE_DST_MAC_ADDR = ATTR_INIT_A12 + 5,
	MKEEP_ALIVE_ATTRIBUTE_PERIOD_MSEC = ATTR_INIT_A12 + 6,
	MKEEP_ALIVE_ATTRIBUTE_ETHER_TYPE = ATTR_INIT_A12 + 7,
...
enum andr_wifi_attr {
	ANDR_WIFI_ATTRIBUTE_INVALID = ATTR_INIT_A12 + 0,
	ANDR_WIFI_ATTRIBUTE_NUM_FEATURE_SET = ATTR_INIT_A12 + 1,
	ANDR_WIFI_ATTRIBUTE_FEATURE_SET = ATTR_INIT_A12 + 2,
	ANDR_WIFI_ATTRIBUTE_RANDOM_MAC_OUI = ATTR_INIT_A12 + 3,
	ANDR_WIFI_ATTRIBUTE_NODFS_SET = ATTR_INIT_A12 + 4,
	ANDR_WIFI_ATTRIBUTE_COUNTRY = ATTR_INIT_A12 + 5,
	ANDR_WIFI_ATTRIBUTE_ND_OFFLOAD_VALUE = ATTR_INIT_A12 + 6,
	ANDR_WIFI_ATTRIBUTE_TCPACK_SUP_VALUE = ATTR_INIT_A12 + 7,
	ANDR_WIFI_ATTRIBUTE_LATENCY_MODE = ATTR_INIT_A12 + 8,
	ANDR_WIFI_ATTRIBUTE_RANDOM_MAC = ATTR_INIT_A12 + 9,
	ANDR_WIFI_ATTRIBUTE_TX_POWER_SCENARIO = ATTR_INIT_A12 + 10,
	ANDR_WIFI_ATTRIBUTE_THERMAL_MITIGATION = ATTR_INIT_A12 + 11,
	ANDR_WIFI_ATTRIBUTE_THERMAL_COMPLETION_WINDOW = ATTR_INIT_A12 + 12,
	ANDR_WIFI_ATTRIBUTE_VOIP_MODE = ATTR_INIT_A12 + 13,
	ANDR_WIFI_ATTRIBUTE_DTIM_MULTIPLIER	= ATTR_INIT_A12 + 14,
	ANDR_WIFI_ATTRIBUTE_CHAN_POLICY = ATTR_INIT_A12 + 15,
	ANDR_WIFI_ATTRIBUTE_ML_POLICY = ATTR_INIT_A12 + 16,
