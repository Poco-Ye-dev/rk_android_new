...
#if defined(DHD_DFS_MASTER) || (LINUX_VERSION_CODE >= KERNEL_VERSION(5, 4, 0))
void
...
#endif /* KERNEL_VERSION(5, 19, 2) || defined(WL_MLO_BKPORT) */
#endif /* WL_MLO */
	uint8 link_id = 0;
	struct bcm_cfg80211 *cfg = wl_get_cfg(dev);
...
#endif /* WL_MLO */
#if LINUX_VERSION_CODE >= KERNEL_VERSION(5, 19, 2) || defined(WL_MLO_BKPORT)
			wdev_chandef(wdev, link_id)->chan = chandef.chan;
#else
...
#endif /* LINUX_VERSION >= VERSION(6,12,0) */
			WL_MSG(dev->name, "send CAC event\n");
...
#endif /* LINUX_VERSION >= VERSION(4,17,0) */
}
#endif /* DHD_DFS_MASTER || LINUX_VERSION_CODE >= KERNEL_VERSION(5, 4, 0) */
